...
public class Task2 {
    ...
    public static void main(String[] args) {
        ...
        //String s = "ab12c" , t = "1zz456";
        String s = "ab12c" , t = "ab24z";
        //System.out.println(s.replaceAll("[0-9]", ""));
        //System.out.println(s);
        System.out.println(task2.solution(s, t));
    ...
    int solution(String s, String t) {
        ...
        for(; index < s.length(); index++) {
            ...
            if(Character.isDigit(s.charAt(index))) {
                temp = s.replaceFirst(String.valueOf(s.charAt(index)), "");
        ...
        for(; index < t.length(); index++) {
            ...
            if(Character.isDigit(t.charAt(index))) {
                temp = t.replaceFirst(String.valueOf(t.charAt(index)), "");
